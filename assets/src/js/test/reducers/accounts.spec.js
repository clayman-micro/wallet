...
describe('Accounts reducer', () => {
    ...
    describe('Get accounts', () => {
        ...
        it('should handle GET_ACCOUNTS_RESPONSE with empty initial state', () => {
            ...
            expect(reducer(undefined, action)).to.deep.equal({
                status: StatusChoices.FETCH_DONE, items: accounts, errors: {}
            });
        });
    ...
    describe('Create account', () => {
        ...
        it('should handle CREATE_ACCOUNT_RESPONSE', () => {
            ...
            expect(reducer(undefined, action)).to.deep.equal({
                status: StatusChoices.CREATE_DONE, items: [{
                    id: 1, name: 'Debit card', original_amount: 30000.0
                }], errors: {}
            });
        });
    ...
    describe('Edit account', () => {
        ...
        const initialState = { errors: {}, items: [account] };
        ...
        it('should handle EDIT_ACCOUNT_REQUEST', () => {
            ...
            expect(reducer(initialState, action)).to.deep.equal({
                status: StatusChoices.EDITING, items: [account], errors: {}
            });
        });
        ...
        it('should handle EDIT_ACCOUNT_RESPONSE', () => {
            ...
            expect(reducer(initialState, action)).to.deep.equal({
                status: StatusChoices.EDIT_DONE, items: [{
                    id: 1, name: 'Debit card', original_amount: 20000.0
                }], errors: {}
            });
        });
        ...
        it('should handle EDIT_ACCOUNT_FAILED', () => {
            ...
            expect(reducer(initialState, action)).to.deep.equal({
                status: StatusChoices.FAILED, items: [account], errors: { name: 'Already exist' }
            });
        });
    });
    ...
    describe('Remove account', () => {
        ...
        it('should handle REMOVE_ACCOUNT_REQUEST', () => {
            ...
            expect(reducer(initialState, action)).to.deep.equal({
                status: StatusChoices.REMOVING, items: [account], errors: {}
            });
        });
        ...
        it('should handle REMOVE_ACCOUNT_FAILED', () => {
            ...
            expect(reducer(initialState, action)).to.deep.equal({
                status: StatusChoices.FAILED, items: [account], errors: { id: 'Does not exist' }
            });
        });
    });
});
